# Integration State: strncmp-over-read-fix

## Summary

- Date: 2026-09-10
- Note: libphoenix strncmp/strncasecmp read one byte past n (f2d2789) + page-edge regression test (7c80324); STK now reaches the race instead of faulting in AngelScript's tokenizer
...
| --- | --- | --- | --- |
| _build | main | baea6342d (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | f2d2789 (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
_build	baea6342da9704728f51d761a797ff54e8aef4ce	main
libphoenix	f2d2789b202631e7cbb270f509ebda444db55bac	master
