# Integration State: wedge-fix-verified

## Summary

- Date: 2026-09-09
- Note: kernel f0e94a9b: dangling thread->process no longer wedges the board (printf self-deadlock + assert-halt both removed); 20/20 clean desktop exits; recovery path demonstrated by fault injection
...
| --- | --- | --- | --- |
| _build | main | 78d27bda6 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	78d27bda657206649db7dc3d4e6e3fecb6a6f6b1	main
