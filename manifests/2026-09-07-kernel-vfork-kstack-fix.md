# Integration State: 2026-09-07-kernel-vfork-kstack-fix

## Summary

- Date: 2026-09-06
- Note: EL1 Data Abort on wmaker teardown fixed (vfork lent-kstack); fresh export with all 5 games + CA bundle; GPU desktop HW-verified 0 faults
...
| --- | --- | --- | --- |
| _build | main | 770fb55bf (dirty(3)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-ports | master | 7391013 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-ports.git |
| phoenix-rtos-posixsrv | master | 8a44ce8 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-posixsrv.git |
| phoenix-rtos-project | master | 7787ac8 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-project.git |
...
_build	770fb55bffa19a49778258aa04a4c5c1df835589	main
...
phoenix-rtos-ports	7391013dfc5012e136c55c23052211fc784d5576	master
phoenix-rtos-posixsrv	8a44ce8eb9851e3bac36e36165e26ca8e879530f	master
phoenix-rtos-project	7787ac8f3ec33bca648d3629fbf3d754aa0c8cad	master
