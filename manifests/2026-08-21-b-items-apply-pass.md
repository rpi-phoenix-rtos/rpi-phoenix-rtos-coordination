# Integration State: 2026-08-21-b-items-apply-pass

## Summary

- Date: 2026-08-21
- Note: Upstream B-items apply pass (owner-authorized): B14+B2 xHCI (devices 25e5c9a), B8 pl011-tty batch-wake, B7b genet dsb (lwip 87ff8db local); HW non-regression-verified (boot+USB+netboot+console-input, 0 faults); B5 deferred (cross-board/attended)
...
| --- | --- | --- | --- |
| _build | main | 6f02347 (dirty(3)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | 25e5c9a (dirty(2)) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	6f0234776d56f5eefdb70a82fef9f322936aeebc	main
...
phoenix-rtos-devices	25e5c9ae8c55a46d21696facb03b0f550a382a4a	master
