# Integration State: 2026-05-25-watchdog-software-reboot

## Summary

- Date: 2026-05-25
- Note: Watchdog software reboot working. diag-udp 'r'/'h' fires the BCM2711 PM watchdog 100ms post-reply; Pi netboots ~65s later. Saves ~30s per test cycle vs Meross smart-plug. scripts/pi_reboot.sh added.
...
| --- | --- | --- | --- |
| _build | main | 4632f27 (dirty(6)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | 523eff1 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	4632f279e22a6f77ff7790902402882018da8758	main
...
phoenix-rtos-lwip	523eff121bdf12c96777e49f6d302cfc004ab93e	agent/rpi4-genet
