# Integration State: malloc-release-guard

## Summary

- Date: 2026-09-12
- Note: libphoenix: _malloc_chunkRemove reports success; heap release leaks instead of unmapping when the chunk is still binned. Regression: stdlib 93/0, misc 212/0, pthread_tsd 4/0, 0 faults. NOTE the 12-trial post-fix STK arm had 0 abandons, so the new guard never fired -- its 0 crashes do NOT validate this fix.
...
| --- | --- | --- | --- |
| _build | main | a326d2acf (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | 54549e6 (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
_build	a326d2acf41b3d59207765253a4e81124fb9beb1	main
libphoenix	54549e69f66b1d546a974c082778debcc29dd488	master
