# Integration State: libc-clean-on-lheap-instrument

## Summary

- Date: 2026-09-11
- Note: 541 libc tests 0 failures on libphoenix b6b7f29 (stdlib 93, string 208, misc 212/11 ignored, pthread 28), with ZERO spurious instrument fires: no 'not a plausible chunk', no lheap? lines, no exceptions. Confirms the live-heap ring's bookkeeping does not misreport and the release-path loop under the allocator mutex causes no contention failure.
...
| --- | --- | --- | --- |
| _build | main | 01fdca934 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | b6b7f29 (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
_build	01fdca934483d13520e5c62525f5a669ab651f9a	main
libphoenix	b6b7f2917f461dbb8dc1e9750418d335b1465612	master
