# Integration State: 2026-07-17-upstream-merged-validated

## Summary

- Date: 2026-07-17
- Note: Full mainline upstream merge (all 16 siblings; libphoenix RTOS-1132 libmcs resolved take-theirs + math shim weak; usb kept #121 guards). Builds, boots, Quake renders correctly on HW (netboot). Capture-readback WIP (buffer-index unresolved). SD card NOT reflashed (still flicker-fixed pre-upstream).
...
| --- | --- | --- | --- |
| _build | main | 3667ff4 (dirty(23)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-filesystems | master | 608c216 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-filesystems.git |
...
_build	3667ff4cc5f52c1d146c5a362d08307e7c95ca29	main
...
phoenix-rtos-filesystems	608c21664cb5b2b3ea6d8bf75c1729e441d6bcac	master
