# Integration State: 2026-08-25-bash-interactive-select-fix

## Summary

- Date: 2026-08-25
- Note: libphoenix select(NULL) blocks (was 0-return) -> interactive bash HW-verified working
...
| --- | --- | --- | --- |
| _build | main | e53b43d (dirty(7)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | 033ee1f (clean) | https://github.com/phoenix-rtos/libphoenix.git |
| phoenix-rtos-build | master | 7463000 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-build.git |
...
| phoenix-rtos-tests | master | 1f6e9e9 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-tests.git |
...
_build	e53b43d0067ffd02d41e9ac927c877d81e58803a	main
libphoenix	033ee1f307b43c11c36874569227f9e854edf0b5	master
phoenix-rtos-build	7463000c291c1124ef6229ce8a674862f8f25822	master
...
phoenix-rtos-tests	1f6e9e992603aec0b2332143cf0882ab4ccb0974	master
