# Integration State: 2026-05-26-usb-iterL-h4-confirmed

## Summary

- Date: 2026-05-25
- Note: USB Iteration L (full xHCI bring-up from side process) — v1/v2/v3 all HSE on R/S=1. Matches Linux xhci_run order exactly. H4 (bus-master DMA path) DEFINITIVELY confirmed across separate process. Code-only fixes exhausted; JTAG/PCIe analyzer required.
...
| --- | --- | --- | --- |
| _build | main | 8c8666b (dirty(6)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | 4928683 (dirty(1)) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	8c8666b0118c5507583d608a91e82f1120b295e8	main
...
phoenix-rtos-lwip	4928683a2c89f18d26def16d05cfd4c10349a366	agent/rpi4-genet
