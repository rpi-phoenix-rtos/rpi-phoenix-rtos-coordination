# Integration State: six-component-demo-image

## Summary

- Date: 2026-09-07
- Note: 6/6 demo components gated 3 trials each (18 boots, 0 faults): desktop, Q3, QuakeSpasm, Q2, vkQuake and SuperTuxKart. Carries the STK ogg stack-buffer fix, libphoenix pthread guard page + 256KiB default stack, the kernel user-fault stack window, the nfs-fs fast path, and upstream libphoenix 067ea81.
...
| --- | --- | --- | --- |
| _build | main | 326555096 (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
_build	326555096a90e8147216ce55dcc0e816d202d494	main
