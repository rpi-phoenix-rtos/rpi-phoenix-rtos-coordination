# Integration State: 2026-08-21-ctypes-dlopen-pathsearch

## Summary

- Date: 2026-08-20
- Note: dl_hostInit PATH fallback; ctypes FFI works via bare python3 (CTYPES-OK)
...
| --- | --- | --- | --- |
| _build | main | 2159f13 (dirty(3)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | d30d36e (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
| phoenix-rtos-ports | master | 3639dff (clean) | https://github.com/phoenix-rtos/phoenix-rtos-ports.git |
...
_build	2159f1361d58b9e22494349b9641cb4b901e51a5	main
libphoenix	d30d36ed132eb147f0356a6010b28f86c3318fab	master
...
phoenix-rtos-ports	3639dff69edc85ec442e2f62f2bf496c99a49737	master
