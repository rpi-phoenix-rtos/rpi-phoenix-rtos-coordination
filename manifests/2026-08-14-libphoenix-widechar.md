# Integration State: 2026-08-14-libphoenix-widechar

## Summary

- Date: 2026-08-14
- Note: libphoenix wide-char completion: wcspbrk/wcsspn/wcscspn/wcsstr/wcstok + wcsto{l,ul,ll,ull,d,f,ld}, host-tested vs glibc; unblocks CPython link + wchar-heavy ports
...
| --- | --- | --- | --- |
| _build | main | cddd873 (dirty(26)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | 54df17b (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
_build	cddd87309bb6240294978fad1e5d591680053656	main
libphoenix	54df17bf7523218d4709257cf11ce468a190b540	master
