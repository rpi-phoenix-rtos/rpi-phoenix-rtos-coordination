# Integration State: reel-capable-demo-image

## Summary

- Date: 2026-09-08
- Note: SD image ce9ae9f0: ports d7de9aa (vkquake demo hook) + libphoenix a595099 + browse mode; contents gate PASS, QEMU structural PASS, all 6 demo components HW-gated 0 faults with frames verified
...
| --- | --- | --- | --- |
| _build | main | c1b632670 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-ports | master | d7de9aa (clean) | https://github.com/phoenix-rtos/phoenix-rtos-ports.git |
...
_build	c1b632670b70e43bd43c5400b5f597f2225aa3e0	main
...
phoenix-rtos-ports	d7de9aaa9220a60f80c053c1099965fc6f3ae411	master
