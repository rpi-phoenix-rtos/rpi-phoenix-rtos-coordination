# Integration State: nfs-perf-lazyclose-plus-diag-cleanup

## Summary

- Date: 2026-06-08
- Note: NFS #156: lazy-close fh-cache perf fix (exec-from-NFS fast) + DIAG/unused-kernel-fallback cleanup; netboot+nfsroot regression PASS, 0 faults
...
| --- | --- | --- | --- |
| _build | main | b3ff3d1 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | d5461a9 (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
| phoenix-rtos-filesystems | master | 4a754cf (clean) | https://github.com/phoenix-rtos/phoenix-rtos-filesystems.git |
...
_build	b3ff3d1a9520bf3f6b0b7441ad6cafe96306ddea	main
libphoenix	d5461a9ec00da5809327cff20aed7bfc37cf5b0e	master
...
phoenix-rtos-filesystems	4a754cf831c59db6571ffcf150b5639a4861a0da	master
