# Integration State: c1-wide-heap-trace

## Summary

- Date: 2026-09-25
- Note: C1 hunt: trace every heap >=0x5000 (budget 192) + ralloc get_gc_block_header positive control. STK 133e1227d09bc8ee. Ralloc hypothesis eliminated; victim heap is a fragment of an untraced size.
...
| --- | --- | --- | --- |
| _build | main | d8fe33c7e (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | b871cbc (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
| phoenix-rtos-devices | master | ec654c0 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	d8fe33c7e6dee3d3565c274686430de953919bc9	main
libphoenix	b871cbce0de8504a0985c0b992ea34b6cd2be225	master
...
phoenix-rtos-devices	ec654c010814fc9c540bd5506421642adbf1e691	master
