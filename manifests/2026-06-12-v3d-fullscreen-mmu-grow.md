# Integration State: 2026-06-12-v3d-fullscreen-mmu-grow

## Summary

- Date: 2026-06-12
- Note: Fullscreen 1024x768 RENDERS: winsys MMU flat PT grown 4MiB->128MiB GPU VA window (was capped at 1 PT page; 1024x768 color+depth overflowed it -> OOB PTE write + unmapped VA -> all-zero RT). + bounds guard. Cube native 1024x768, COVER=100% of 786432px, 1200+ frames 0 faults, crisp 3-face-corner cube on HDMI. Clears the fullscreen Quake-viewport gate. Image SHA 36ae4f92.
...
| --- | --- | --- | --- |
| _build | main | 21850b8 (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | 8326051 (dirty(2)) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
| phoenix-rtos-project | master | dabc55c (dirty(1)) | https://github.com/phoenix-rtos/phoenix-rtos-project.git |
...
_build	21850b85cbf6a5251a66cbed76edd26a29cb0f18	main
...
phoenix-rtos-devices	832605168854528a92015efdcd18263d78030d46	master
...
phoenix-rtos-project	dabc55cd9de30e4453171e946a9942d27727abbb	master
