# Integration State: malloc-bin-link-guard

## Summary

- Date: 2026-09-09
- Note: libphoenix 2d55b1e: free-bin links value-checked before LIST_REMOVE (abandons the bin on garbage); addresses a MEASURED STK crash site (lib_listRemove). HW: stdlib 92/0, unix-socket 27/0, desktop clean, 0 false positives
...
| --- | --- | --- | --- |
| _build | main | df1de9705 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | 2d55b1e (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
_build	df1de97050aa7a0026a540fd6b3c67203b90ecd5	main
libphoenix	2d55b1e84b33ab6be8f1b4c016e3fd841d0ffd21	master
