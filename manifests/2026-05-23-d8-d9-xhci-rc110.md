# Integration State: d8-d9-xhci-rc110

## Summary

- Date: 2026-05-23
- Note: SMP D-8+D-9 active + xhci event-ring-before-R/S fix. Boot reaches psh prompt. USB gets rc=-110 (vs prior rc=-19) — cap-probe succeeds, deeper xhci init exercised.
...
| --- | --- | --- | --- |
| _build | main | bb2357c (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
_build	bb2357c1a54ab87ef738667f66a712fe620917c1	main
