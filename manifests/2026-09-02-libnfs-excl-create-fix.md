# Integration State: libnfs-excl-create-fix

## Summary

- Date: 2026-09-02
- Note: libnfs OPEN-create EXCLUSIVE4 typo fixed (garbage atime + mode 000 gone); libc/misc 207/0, libc/stdio 80/0
...
| --- | --- | --- | --- |
| _build | main | aeb6a863f (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	aeb6a863f24f0a2fd50147378ae97b156787375f	main
