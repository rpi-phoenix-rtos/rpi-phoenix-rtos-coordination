# Integration State: pthread-detached-stack-reclaim

## Summary

- Date: 2026-09-01
- Note: libphoenix c8ee89e: no-leak reclaim of detached-thread stacks (retired-list + threadJoin from a live thread), replaces the 4c97a79 interim leak; HW-verified 1000-thread churn 0 failures + test-libc-semaphore 3/0
...
| --- | --- | --- | --- |
| _build | main | 3851dea67 (dirty(9)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | c8ee89e (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
_build	3851dea67a6f698e6178d02bf42bcf66e74e0f4b	main
libphoenix	c8ee89ed59367115172f3ca4caf08da56b249e9e	master
