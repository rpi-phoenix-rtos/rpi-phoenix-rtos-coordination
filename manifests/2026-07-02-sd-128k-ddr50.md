# Integration State: 2026-07-02-sd-128k-ddr50

## Summary

- Date: 2026-07-01
- Note: SD 128K transfers + 128K libcache sector + DDR50; read 38/write 17 MB/s netboot, SD-boot HS50 floor, 0 corrupt, 0 faults; diag off
...
| --- | --- | --- | --- |
| _build | main | 1befbf8 (dirty(8)) | https://github.com/houp/phoenix-rpi.git |
