# Integration State: demo-image-prio64

## Summary

- Date: 2026-09-09
- Note: SD image e0768b87: carries the 8->64 priority merge, all 3 kernel fixes, libphoenix double-free report and STK scale_rtts 0.75; 6/6 apps HW-re-gated on this tree, contents+FAT and QEMU gates PASS
...
| --- | --- | --- | --- |
| _build | main | d24a5c64b (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | dd7aad9 (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
_build	d24a5c64b24aa5fe93c02ac8d89ce2ffd56014ab	main
libphoenix	dd7aad981bc25037352ef510c5bfa1bd9fdc356c	master
