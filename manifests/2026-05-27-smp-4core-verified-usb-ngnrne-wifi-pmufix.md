# Integration State: 2026-05-27-smp-4core-verified-usb-ngnrne-wifi-pmufix

## Summary

- Date: 2026-05-27
- Note: Verified full 4-core SMP scheduling (D-8+D-9 live, all secondaries tick) + boot-to-psh + GENET net. Includes USB nGnRnE MMIO (05ba58b) + INTE|HSEE (65a17ec); USB still walled (inbound-write/process). WiFi PMU diag fixes (5da243d) untested. Known-good rollback point.
...
| --- | --- | --- | --- |
| _build | main | 87fe412 (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | codex/upstream-sync-20260516 | 05ba58b (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | 5da243d (dirty(1)) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	87fe412fa7f079677ec2fe653561ad9d5a802e28	main
...
phoenix-rtos-devices	05ba58b1396d885a93262c079e748c7471a2d6b8	codex/upstream-sync-20260516
...
phoenix-rtos-lwip	5da243da3b7f2b57062d1c83e09b930006ba5a69	agent/rpi4-genet
