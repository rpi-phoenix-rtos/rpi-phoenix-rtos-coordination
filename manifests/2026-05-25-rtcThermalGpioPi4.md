# Integration State: 2026-05-25-rtcThermalGpioPi4

## Summary

- Date: 2026-05-25
- Note: Three small Pi-4-utility landings: BCM2711 PM watchdog reboot (~30s saved per cycle), VC mailbox thermal+throttle telemetry (SoC at 34.5C idle, no throttle events), GPIO Tier 1 read+set helpers (snapshot pinmuxes GPIO 34-39 as INPUT + pull-up — WiFi Tier 1c needs single GPFSEL3 write). All resolve items from docs/research/{rtc-thermal-power,gpio-pinctrl}.md.
...
| --- | --- | --- | --- |
| _build | main | f249287 (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | c55dbce (clean) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	f2492877cf15d281572af389d8a435692de370cd	main
...
phoenix-rtos-lwip	c55dbcef7d79a7e0be6c1e7d35b275ba96d683b2	agent/rpi4-genet
