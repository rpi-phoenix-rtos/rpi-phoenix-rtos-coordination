# Integration State: upstream-prio64-merge

## Summary

- Date: 2026-09-09
- Note: upstream sweep: 8->64 priorities (kernel 0c768551) + setPriority() migration across usb/devices/utils/corelibs; HW-verified boot + desktop exit + AF_UNIX 27/0 + misc 4/0 + STK 8/9/9, 0 kernel faults
...
| --- | --- | --- | --- |
| _build | main | 88210316b (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	88210316bbfe085c1f32d2f30a09ae8b74dcae3f	main
