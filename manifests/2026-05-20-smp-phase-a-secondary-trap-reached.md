# Integration State: smp-phase-a-secondary-trap-reached

## Summary

- Date: 2026-05-20
- Note: SMP Phase A: secondaries wake via spin-table handoff, reach kernel _other_core_trap and exit poll (markers t,v on UART); primary boot still reaches fbcon: ok cleanly. Image SHA 4d1e5ce. Known issue: secondaries loop back through el1_entry many times (Phase B problem).
...
| --- | --- | --- | --- |
| _build | main | ae3ee7a (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-kernel | agent/rpi4-program-reloc | d157a60a (clean) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
_build	ae3ee7a7262323ee16b607ec94b9ed231727dc21	main
...
phoenix-rtos-kernel	d157a60a9085e5911d28ecdc404ee3ccfeb7a8c2	agent/rpi4-program-reloc
