# Integration State: sd-root-stackfix

## Summary

- Date: 2026-06-07
- Note: SD ext2 rootfs WORKING: mount+exec+stable boot. Real fix = enlarge fs pool-thread stacks (storage_run(2,16*_PAGE_SIZE)); root cause was 8KB stack overflow, not ext2. Multithreading preserved. HW-validated 0/10 (was 100% crash at 8KB).
...
| --- | --- | --- | --- |
| _build | main | a90285a (dirty(3)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | 07bb181 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	a90285aadbf445a9edc20bcd1d8e047d3fe2e9aa	main
