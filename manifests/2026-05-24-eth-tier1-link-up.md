# Integration State: 2026-05-24-eth-tier1-link-up.md

## Summary

- Date: 2026-05-24
- Note: Eth Tier 1 complete — GENET v5 driver brings up BCM54213PE PHY,
  autoneg completes (100Mbps full-duplex against the netboot bridge's
  USB-Ethernet adapter), netif comes up as LINK_UP. No TX/RX yet.
...
| --- | --- | --- | --- |
| _build | main | 2540ea4 (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | 76d8aaf (clean) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	2540ea47e260a826f6a1edb7e7b67ad2d78f84c5	main
...
phoenix-rtos-lwip	76d8aaf1eb50b7a52bf9986b51b89901a7c81d41	agent/rpi4-genet
