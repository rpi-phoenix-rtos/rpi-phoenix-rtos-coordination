# Integration State: nfs-readlink-truncation-fix

## Summary

- Date: 2026-09-01
- Note: nfs-fs: stage symlink readlink via full PATH_MAX buffer to dodge libnfs small-buffer status-clobber bug + apply POSIX truncation (fc2f62b); test-libc-misc resolve_path.symlink_long_resolution PASS, misc 4->3, HW-verified
...
| --- | --- | --- | --- |
| _build | main | a819fe7d2 (dirty(10)) | https://github.com/houp/phoenix-rpi.git |
...
_build	a819fe7d2bf94937e6ab801adca1a97f874d083a	main
