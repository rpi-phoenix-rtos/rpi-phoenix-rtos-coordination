# Integration State: sd-root-exec-working

## Summary

- Date: 2026-06-07
- Note: SD ext2 root: mount + exec-from-card working; storage_run(1) fixes the ext2-obj-cache concurrency crash (4/4 -> 0/3). HW-validated SD-boot, HDMI-confirmed psh.
...
| --- | --- | --- | --- |
| _build | main | b979b7c (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | 0982cdb (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	b979b7ca1c05bec0442be41b7dab78989002344f	main
...
phoenix-rtos-devices	0982cdb825133043b39fe3cfd3b6b5a820c8c70d	master
