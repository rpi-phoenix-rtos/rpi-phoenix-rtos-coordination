# Integration State: x11-utils-merge-demo-image

## Summary

- Date: 2026-09-09
- Note: SD image: all X11 work + the upstream psh ps/top priority-width merge (utils 13247f9) + the inert Mesa BO-import path. Gates: contents PASS, QEMU boot PASS (SD variant), 6-app re-gate after two relinks. STK races but has its known intermittent crash (3/6 runs, three different sites, app-side). SHA256 5ace5d4b59c830c40f3d012cd6543ce655bfabeaaf0d1684c21c5de4a64e5782
...
| --- | --- | --- | --- |
| _build | main | c71621ffc (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	c71621ffcf1011bc76bb5f05f72d20773884be1a	main
