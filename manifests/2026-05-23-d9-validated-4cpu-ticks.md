# Integration State: d9-validated-4cpu-ticks

## Summary

- Date: 2026-05-23
- Note: FULL SMP CONFIRMED. main_initthr's 15s-later smp:tick reads cpu0=15242 cpu1=5038 cpu2=5038 cpu3=5038 — all 4 CPUs taking ticks at the same rate. D-8 defer + D-9 re-arm working end-to-end. Boot reaches psh prompt.
...
| --- | --- | --- | --- |
| _build | main | bc5d894 (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | codex/upstream-sync-20260516 | 3696617 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	bc5d894eb6ef6a89057a951763773cc04b9492af	main
...
phoenix-rtos-devices	369661768f94f5e5c3e074f3c6a2d8ae2bf3a5e8	codex/upstream-sync-20260516
