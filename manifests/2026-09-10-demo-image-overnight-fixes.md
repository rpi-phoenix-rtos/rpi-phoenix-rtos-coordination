# Integration State: demo-image-overnight-fixes

## Summary

- Date: 2026-09-10
- Note: SD image 1afa724b: promoted libstdc++ toolchain, libphoenix clock_getres + malloc bin-abandon + readlink clamp, nfs-fs attr-cache-by-inode, wmaker nice() shim fix, yquake2 upstream sync, CPython *at/sched/clock_getres. Gates: contents+FAT PASS, QEMU structural PASS, in-image build-versions carry the overnight SHAs
...
| --- | --- | --- | --- |
| _build | main | 84bdc8d42 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	84bdc8d42e6dd0186dacefb997ec5e3a6c1cfb47	main
