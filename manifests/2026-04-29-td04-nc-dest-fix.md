# Integration State: td04-nc-dest-fix

## Summary

- Date: 2026-04-29
- Note: TD-04 Normal Non-Cacheable dest mapping fix landed; kernel reaches _hal_init (marker f) past previous stuck point at marker o
...
| --- | --- | --- | --- |
| libphoenix | master | 67968a2 (clean) | https://github.com/phoenix-rtos/libphoenix |
...
| phoenix-rtos-devices | master | f0f97ae (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
| phoenix-rtos-kernel | agent/rpi4-program-reloc | cff18d49 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
| phoenix-rtos-project | master | e8f794f (clean) | https://github.com/phoenix-rtos/phoenix-rtos-project.git |
...
| phoenix-rtos-utils | master | 63d2b08 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-utils/ |
| plo | codex/common-aarch64-platform-makefiles | db9724b (clean) | https://github.com/phoenix-rtos/plo.git |
...
libphoenix	67968a289e2fe2280164694e7eb24e09b01db03a	master
...
phoenix-rtos-devices	f0f97ae33fcde828bc3145280f0872adca3581a6	master
...
phoenix-rtos-kernel	cff18d49779c2ceea07edb9e6709a864c423e25c	agent/rpi4-program-reloc
...
phoenix-rtos-project	e8f794ffedadc430e2f8df534f66c0a26befc7d3	master
...
phoenix-rtos-utils	63d2b089cfaaa742ec6e8ffd1eea5c84887721da	master
plo	db9724ba14a27c4ee0a5a665c67185a47529fc73	codex/common-aarch64-platform-makefiles
```
