# Integration State: 2026-05-25-wifi-tier0-sdio-scout

## Summary

- Date: 2026-05-25
- Note: WiFi Tier 0 SDIO controller scout done. SDHCI @ 0xfe300000 is the WiFi target per Pi 4 Linux DT. GPFSEL3=0x0 confirms boot-time pinctrl not applied. WiFi Tier 1 = write SDHCI driver targeting that controller.
...
| --- | --- | --- | --- |
| _build | main | 3eadddd (dirty(6)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | 124a99b (clean) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	3eadddda74a186e9c18aa68dbdc6a0e0c397225a	main
...
phoenix-rtos-lwip	124a99b69d166399cae96000a53e2bbab336695f	agent/rpi4-genet
