# Integration State: nfs-attr-cache-by-inode

## Summary

- Date: 2026-09-10
- Note: nfs-fs 4f2d8fd: attribute cache invalidated for EVERY name of a changed inode on unlink/link (was: stale st_nlink for up to the 100ms TTL). HW: test-libc-misc 208/0 (whole suite clean; that case had failed since 2026-09-01), nlink 9/0 x2, dirent 38/0, boot 0 faults
...
| --- | --- | --- | --- |
| _build | main | b91772457 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-tests | master | 007c67c (clean) | https://github.com/phoenix-rtos/phoenix-rtos-tests.git |
...
_build	b9177245733ce93a840fb27d4a651e0abb559e7b	main
...
phoenix-rtos-tests	007c67cde665c57333a8e0317b71c660652540e8	master
