# Integration State: xhci-cmd-doorbell-issue

## Summary

- Date: 2026-05-24
- Note: USB: 100ms PERST hold + 100ms post-PERST wait eliminate HSE during cmd processing. New state: USBSTS=0x10 (no HSE), USBCMD=0x01 (R/S still set), CRCR_LO=0 (CRR=0), event[0]=0. Controller running but doesn't process cmd ring. Next: investigate doorbell delivery / CRCR retention.
...
| --- | --- | --- | --- |
| _build | main | 39e14a4 (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | codex/upstream-sync-20260516 | 7cf9415 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	39e14a42bdc6d7ac79087640918f7024ed25b4ba	main
...
phoenix-rtos-devices	7cf94157823bb79c4312f4a6b437027f7003ddfd	codex/upstream-sync-20260516
