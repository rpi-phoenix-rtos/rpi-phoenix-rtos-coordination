# Integration State: td14-strategy-ab-checkpoint

## Summary

- Date: 2026-05-02
- Note: Probe-strip + ttyopen-nonfatal landed; QEMU faster (psh)%; Pi 4 still TD-04-class slow lookup() — 600s not enough
...
| --- | --- | --- | --- |
| libphoenix | master | 43e050d (clean) | https://github.com/phoenix-rtos/libphoenix |
...
| phoenix-rtos-devices | master | 3a3ee35 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
| phoenix-rtos-kernel | agent/rpi4-program-reloc | 37fcc58e (clean) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
| phoenix-rtos-project | master | 21bda55 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-project.git |
...
| phoenix-rtos-utils | master | b25b0f8 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-utils/ |
...
libphoenix	43e050de8dfaa080661840b19f97bdad3c0f3920	master
...
phoenix-rtos-devices	3a3ee35ac7931c6d5dc21bea33c82b48d5602f94	master
...
phoenix-rtos-kernel	37fcc58e3a19b825954e71d318e84f9719dd9a8e	agent/rpi4-program-reloc
...
phoenix-rtos-project	21bda5593db482f516a46a30b0b35bab97b8a8f2	master
...
phoenix-rtos-utils	b25b0f8fcba5fb084771da27bc30ca44144f8a31	master
