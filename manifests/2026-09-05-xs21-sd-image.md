# Integration State: xs21-sd-image

## Summary

- Date: 2026-09-05
- Note: SD image rpi4b-sd-2part-xs21-20260905.img (SHA256 92aae062d8...). Supersedes hb14: xorg-server 21.1.24 (fbdev Xphoenix). Gates: 15/15, image PASSES, 336 ELF / 0 stale, image-vs-export 336/336 byte-identical. HW: startx deskapps 98.3% zero warnings on 21.1.24; startx_gpu wmaker 100% on the unchanged 1.20.14 glamor daemon.
...
| --- | --- | --- | --- |
| _build | main | ef974007b (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
_build	ef974007bb76084c4ffeb11adf323aa68f20dace	main
