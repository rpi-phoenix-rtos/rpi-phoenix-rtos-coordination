# Integration State: pcie-poll-stable

## Summary

- Date: 2026-05-21
- Note: PCIe init optimized: polling-based link-up and VL805-firmware wait replace fixed 100+200 ms sleeps. Boot reaches (psh)% in 4/5 cycles in 360 s window (baseline was 2/3). SMP Phase A reverted to baseline; PLO_SMP_ENABLE gate preserved for Phase B work.
...
| --- | --- | --- | --- |
| _build | main | 5671645 (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | codex/upstream-sync-20260516 | 5a833e0 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	5671645308ca2dbeb1a5cdd44e51488d6fe8c334	main
...
phoenix-rtos-devices	5a833e08983395b2267ed6b04799c1a80776634f	codex/upstream-sync-20260516
