# Integration State: 2026-06-12-v3d-tumbling-cube-hdmi

## Summary

- Date: 2026-06-12
- Note: Multi-axis depth-tested tumbling cube renders via GL frontend (immediate-mode GL_QUADS + depth + perspective), full-frame COVER=100%, exact full-intensity face colors, 2040+ frames 0 faults, VISIBLE on HDMI. EZ-disable fix (mesa-phoenix-port.patch) + fresh libv3d. Image SHA 723ac074.
...
| --- | --- | --- | --- |
| _build | main | 6e3716f (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | e72b36e (dirty(2)) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	6e3716f8ee64b0d341cdbe01ed323e4c8e6abf81	main
...
phoenix-rtos-devices	e72b36ef77b8f856ded07cc478996d31076d2246	master
