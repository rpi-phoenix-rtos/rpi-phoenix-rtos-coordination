# Integration State: kmalloc-zone-link-guard

## Summary

- Date: 2026-09-09
- Note: kernel ac40dcf1: validate zone list links before LIST_REMOVE; HW-verified boot + desktop + clean session exit, guard does not false-positive
...
| --- | --- | --- | --- |
| _build | main | 3b1cd513b (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-kernel | master | ac40dcf1 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
_build	3b1cd513bcf822f3354f15ed29a2f05069a0880a	main
...
phoenix-rtos-kernel	ac40dcf11f793d270edcdadc5b8ed415d51d6381	master
