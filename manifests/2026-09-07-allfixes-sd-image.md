# Integration State: 2026-09-07-allfixes-sd-image

## Summary

- Date: 2026-09-07
- Note: SD image with the Mesa u_vbuf dropped-draw fix, kernel vfork/kstack fixes, Q2 underwater fix, CA bundle and the upstream merge; 5 games + GPU desktop HW-verified, image gate PASSES
...
| --- | --- | --- | --- |
| _build | main | 7964eaa66 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-ports | master | bcaeedf (clean) | https://github.com/phoenix-rtos/phoenix-rtos-ports.git |
...
_build	7964eaa6656d230c781e2c426cf5a269f39af22a	main
...
phoenix-rtos-ports	bcaeedfbd44b58f940b964ccf9d9f8e18e98448e	master
