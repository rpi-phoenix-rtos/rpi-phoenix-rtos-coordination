# Integration State: nfs-fifo-support

## Summary

- Date: 2026-09-02
- Note: nfs-fs supports FIFOs/device nodes on an NFS root (mkfifo+stat+open); libc/stdio 0 failures, libc/misc 3->2
...
| --- | --- | --- | --- |
| _build | main | a1e7819db (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	a1e7819dbfa76edb8b48bdbac2ca6aa78a514046	main
