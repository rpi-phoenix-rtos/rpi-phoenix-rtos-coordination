# Integration State: d7-4cpu-enum-cpu0-scheduler

## Summary

- Date: 2026-05-23
- Note: SMP Phase D-7: all 4 cpus enumerate + HAL init; scheduler runs on cpu0 only. Boot reaches fbcon+USB attempt cleanly.
...
| --- | --- | --- | --- |
| _build | main | 8584229 (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | codex/upstream-sync-20260516 | 77fe93a (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
| phoenix-rtos-kernel | agent/rpi4-program-reloc | bb5e158f (clean) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
| phoenix-rtos-project | codex/upstream-sync-20260516 | 14f081b (clean) | https://github.com/phoenix-rtos/phoenix-rtos-project.git |
...
| plo | codex/upstream-sync-20260516 | 0722997 (clean) | https://github.com/phoenix-rtos/plo.git |
...
_build	8584229449991cc73b71473082e196b3b1a4c9f0	main
...
phoenix-rtos-devices	77fe93a6a5b5fe64bb19148000555d749ab634ab	codex/upstream-sync-20260516
...
phoenix-rtos-kernel	bb5e158f8d31692bb70594c63c45ea1fa0e65600	agent/rpi4-program-reloc
...
phoenix-rtos-project	14f081b91e9377313168678ef077d0a85970aa23	codex/upstream-sync-20260516
...
plo	0722997964f02a8aaf1efbb7871398fd2f732780	codex/upstream-sync-20260516
```
