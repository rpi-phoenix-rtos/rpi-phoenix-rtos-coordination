# Integration State: x21both-sd-image

## Summary

- Date: 2026-09-05
- Note: SD image rpi4b-sd-2part-x21both-20260905.img (SHA256 c18ebeb50b...). BOTH X servers on xorg-server 21.1.24 (fbdev Xphoenix + glamor GPU daemon) plus the FB-0 guard and harfbuzz 14.4.0. Gates: 15/15, image PASSES, 336 ELF / 0 stale, image-vs-export 336/336 byte-identical. HW: startx deskapps 98.3% zero warnings; startx_gpu deskapps 98.3% zero exceptions.
...
| --- | --- | --- | --- |
| _build | main | 626246d24 (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-ports | master | 2557667 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-ports.git |
...
_build	626246d24b3e299f325668f82c9662aa2a628e58	main
...
phoenix-rtos-ports	255766754f5bce2f4a2a644dd9b144a3e0717707	master
