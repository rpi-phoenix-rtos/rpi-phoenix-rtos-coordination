# Integration State: 2026-08-28-gcc16-promoted-default

## Summary

- Date: 2026-08-27
- Note: gcc-16.2.0 is the DEFAULT toolchain (.toolchain; gcc-14 kept as .toolchain-gcc14 rollback). Whole system gcc-16-built + boot-verified: kernel ELF + loader.disk = GCC 16.2.0, all ports gcc-16 this session, --with-ports integration image booted + ran jq/awk/xz/stty/python 0 faults
...
| --- | --- | --- | --- |
| _build | main | 9e53c97 (dirty(9)) | https://github.com/houp/phoenix-rpi.git |
...
_build	9e53c977e0ee7edf8a90e351025331fb754ac5b2	main
