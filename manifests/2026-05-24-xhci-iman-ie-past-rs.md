# Integration State: xhci-iman-ie-past-rs

## Summary

- Date: 2026-05-24
- Note: IMAN.IE = 1 before R/S=1 (devices a4dcbe8) moves HSE past R/S=1 transition. R/S=1 now clean; cmd ring DMA path still has issues (USBSTS=0x15 during cmd processing, event[0]=0). Progress: R/S transition reliable.
...
| --- | --- | --- | --- |
| _build | main | c37cfdb (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | codex/upstream-sync-20260516 | a4dcbe8 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	c37cfdb4cd35c1810bc1370cca2b517409f6ec39	main
...
phoenix-rtos-devices	a4dcbe8d07958ac78725fc645ce177d1dc52508f	codex/upstream-sync-20260516
