# Integration State: 2026-05-26-wifi-tier3-chip-enumerated

## Summary

- Date: 2026-05-25
- Note: WiFi Tier 3: BCM43455 fully enumerated on SDIO bus. CMD5 voltage-claim with C=1 in 1 iter, CMD3 returns RCA=0x0001, CMD7 selects card, CMD52 reads CCCR reg 0 returning SDIO_REVISION=0x32 (SDIO 3.0). The chip is now addressable and the WHD driver can hook in once chip-id 43455 is added to the supported family list.
...
| --- | --- | --- | --- |
| _build | main | 166de58 (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | b247d0e (dirty(1)) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	166de586be0aa965b1dc2f3e65897a1328d44033	main
...
phoenix-rtos-lwip	b247d0e1c37b14a1df85f75f2402913c1f8d238c	agent/rpi4-genet
