# Integration State: 2026-09-08-psh-cmdsz-hevc-window

## Summary

- Date: 2026-09-08
- Note: psh CMDSZ 128->1024 (silent truncation fixed, HW-verified with a 156-char command) + hevc-play --window (HW H.265 as a window over the live fbcon, HW-verified); X daemon restored to the Mesa e4be116324 link after a relink onto current Mesa SIGILLed
...
| --- | --- | --- | --- |
| _build | main | 89bd713fb (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	89bd713fb35aa98d8415aed6297b828acb5c35ec	main
