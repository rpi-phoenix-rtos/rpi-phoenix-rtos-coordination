# Integration State: 2026-05-25-eth-tier5c-diag-udp

## Summary

- Date: 2026-05-25
- Note: Eth Tier 5c — net-routed observability via UDP diag responder (port 9999). Per-netif counters surface live (rx/tx/drop/timeout/link/MAC source). Skips lo0 (lwip-created, no netif_alloc wrapper) via NETIF_FLAG_ETHARP. Validated: counters increment by +101 after 100 pings. Resolves TD-Eth-Stats.
...
| --- | --- | --- | --- |
| _build | main | 27113cb (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | b261265 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	27113cb9eeaa4dab50298c74d505df15b0dda66d	main
...
phoenix-rtos-lwip	b2612651f8bd325becf65231a273e6848a3d808f	agent/rpi4-genet
