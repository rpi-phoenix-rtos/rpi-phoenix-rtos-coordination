# Integration State: stage2-phase4a-dtb-parsers

## Summary

- Date: 2026-05-05
- Note: Stage 2 phase 4a: kernel DTB parsers for /reserved-memory and /soc/dma-ranges (parsers + accessors only; allocator integration in phase 4b). Phase 5 (config.txt) reverted.
...
| phoenix-rtos-kernel | agent/rpi4-program-reloc | e5b768fa (clean) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
phoenix-rtos-kernel	e5b768fac1d31f39440d8cde085f068eb27ba43f	agent/rpi4-program-reloc
