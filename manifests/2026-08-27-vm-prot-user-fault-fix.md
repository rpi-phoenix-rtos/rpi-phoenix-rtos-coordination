# Integration State: 2026-08-27-vm-prot-user-fault-fix

## Summary

- Date: 2026-08-27
- Note: map_pageFault PROT_USER-from-faulted-map fix (EL1 user-copy fault storm on AF_UNIX recv into forked COW buffer). HW: unix-socket 25/25, exit fork_cow_isolation PASS, 0 Exception #37, clean boot.
...
| --- | --- | --- | --- |
| _build | main | 65e8f07 (dirty(10)) | https://github.com/houp/phoenix-rpi.git |
...
_build	65e8f077bd3e129a6114736fe638e393f5cc4702	main
