# Integration State: d8-d9-active-psh-prompt

## Summary

- Date: 2026-05-23
- Note: SMP D-8 + D-9 active: all 4 cpus enumerate, primary boots through PSH PROMPT. USB cap-probe succeeds (HCIVERSION=0x0100), xhci_runStateSelftest is the next failure. Plo set/way invalidation + ffmpeg HDMI timeout enabled stable test cycles.
...
| --- | --- | --- | --- |
| _build | main | 070c63b (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | codex/upstream-sync-20260516 | 002324e (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
| phoenix-rtos-kernel | agent/rpi4-program-reloc | c4293f3d (clean) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
_build	070c63b1f97d8e9411e6fa716968a47afff035e2	main
...
phoenix-rtos-devices	002324e39c1d33767462adee5295272443f0d7e1	codex/upstream-sync-20260516
...
phoenix-rtos-kernel	c4293f3dae95015652a8e5d11bcef5898f468830	agent/rpi4-program-reloc
