# Integration State: xhci-staged-poll-stable

## Summary

- Date: 2026-05-21
- Note: xhci staged-poll (905b4f8) on top of pcie-poll-stable. 3/3 boot
  cycles reached `(psh)%` prompt with 360 s capture window. Image SHA
  `46d9bd739f233645c30d5d94e73ac9014fdfe072a0a772c49d8cb4801352a29c`.
...
| --- | --- | --- | --- |
| _build | main | 6b3c390 (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | codex/upstream-sync-20260516 | 905b4f8 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	6b3c3904bc4f9a83b9d67bf15db4fc2d49fb50a2	main
...
phoenix-rtos-devices	905b4f86c08209175fca45d61537dba1102cf7aa	codex/upstream-sync-20260516
