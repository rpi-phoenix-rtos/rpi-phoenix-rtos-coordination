# Integration State: gigabit-throughput-2.4x

## Summary

- Date: 2026-08-26
- Note: Gigabit NFS/eth throughput 2.4x (NFS 7.86->18.9 MB/s, raw TCP 116->300 Mbit/s): LWIP_TCPIP_CORE_LOCKING_INPUT + LWIP_CHKSUM_ALGORITHM=3 + GENET_RX_CACHEABLE=1 (bit-exact + GPU+net validated). Requires the lwip stack incl mount-fix.
...
| --- | --- | --- | --- |
| _build | main | db48ec1 (dirty(7)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | master | c3be738 (dirty(5)) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	db48ec1042a09f1469a78f5aeb4285dfe2b96882	main
...
phoenix-rtos-lwip	c3be7384f1320971f19a6f31fbf371e767f61ad4	master
