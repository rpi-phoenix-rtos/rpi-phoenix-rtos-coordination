# Integration State: 2026-05-25-wifi-tier1c-chip-alive

## Summary

- Date: 2026-05-25
- Note: WiFi Tier 1c done: GPFSEL3=0x3ffff000 (GPIO 34-39 ALT3), WL_REG_ON via mailbox expgpio[1] set state=0x1, SDHCI PRES_STATE bits 16-19 go from 0000 to 1111 (CARD_INSERTED + state stable + detect + WP). BCM43455 alive on the bus. Next: CMD0 + CMD5 to discover SDIO function 0.
...
| --- | --- | --- | --- |
| _build | main | 108dd6d (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | e3ab254 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	108dd6da2830b988d98c92781c8f16023a38559b	main
...
phoenix-rtos-lwip	e3ab254a13559297382628d7bfddecb4dc166823	agent/rpi4-genet
