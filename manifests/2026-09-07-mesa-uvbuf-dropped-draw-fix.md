# Integration State: 2026-09-07-mesa-uvbuf-dropped-draw-fix

## Summary

- Date: 2026-09-07
- Note: Mesa u_vbuf no longer silently drops draws on the index-unroll path; Quake III world renders with multitexture ENABLED, 0 dropped draws, 0 faults
...
| --- | --- | --- | --- |
| _build | main | 5d42a8e31 (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-ports | master | edd3359 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-ports.git |
...
_build	5d42a8e3135f5f7dd42167d77a85c00457e34ede	main
...
phoenix-rtos-ports	edd335906e9b204abc75a387f3f28806a8b56e96	master
