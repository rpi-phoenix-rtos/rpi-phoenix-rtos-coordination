# Integration State: libc-suite-clean-on-containment

## Summary

- Date: 2026-09-11
- Note: 541 libc tests 0 failures on the containment build (stdlib 93, string 208, misc 212/11 ignored, pthread 28), with ZERO containment events and zero exceptions during the run -- i.e. the two bin hand-out validations are not rejecting valid input. Regression check on six malloc_dl.c commits.
...
| --- | --- | --- | --- |
| _build | main | a3c5bd6e0 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	a3c5bd6e06ffa0488b2ea0335f861715fa7a984d	main
