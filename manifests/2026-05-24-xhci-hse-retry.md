# Integration State: xhci-hse-retry

## Summary

- Date: 2026-05-24
- Note: USB: HSE-on-R/S=1 soft retry (devices 938af5b) reliably recovers. Two consecutive boots: 1) HSE attempts 0,1; recovered on 2; 2) no HSE first try. Both reach cmd-NOOP timeout rc=-110. The rc=-19 statistical outcome is eliminated.
...
| --- | --- | --- | --- |
| _build | main | 2852895 (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | codex/upstream-sync-20260516 | 938af5b (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	285289588b0c2d22d00dc6887fb6154dfc200f3a	main
...
phoenix-rtos-devices	938af5b3d4fc6e34d0076b81a278fa65143bedbf	codex/upstream-sync-20260516
