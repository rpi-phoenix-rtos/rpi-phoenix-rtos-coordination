# Integration State: 2026-05-25-usb-10-cycle-experiment

## Summary

- Date: 2026-05-25
- Note: USB 10-cycle experiment via diag-udp. H2 (under-voltage) + H3 (side-process MMIO reads) ruled out. H1 (OS-side memory coherence) ruled out via DCBAA[0] readback = 0x03301000 consistent across cycles. Wedge confirmed at VL805 bus-master DMA path (H4) — below OS visibility, needs JTAG/PCIe analyzer. Returning to WiFi/BT.
...
| --- | --- | --- | --- |
| _build | main | f342a30 (dirty(6)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | 666d90e (dirty(1)) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	f342a306159ef501b8f4c898d19b11d7e4ecae95	main
...
phoenix-rtos-lwip	666d90e369dfe035238ea53ca9e81b46daba7093	agent/rpi4-genet
