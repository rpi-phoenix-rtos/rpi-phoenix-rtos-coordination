# Integration State: 2026-08-26-gigabit-ingress-credit

## Summary

- Date: 2026-08-26
- Note: Ingress TCP window crediting: socket-recv 29.6->33.17, NFS 26.3->29.9 MB/s (3.8x cumulative), bit-exact, retrans~0. Pushed NORMALLY post-unblock (lib-lwip 58e89121, phoenix-rtos-lwip e8cc8c5, project 07ba705). lwip repo unblocked this session — full FF push works.
...
| --- | --- | --- | --- |
| _build | main | f9125b5 (dirty(8)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | master | e8cc8c5 (dirty(4)) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	f9125b582bc279146295176ee12adf90bebf747a	main
...
phoenix-rtos-lwip	e8cc8c57952d542b78bba5e433413bb847b939cb	master
