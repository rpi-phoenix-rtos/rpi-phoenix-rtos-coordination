# Integration State: 2026-08-21-timerisset-fix

## Summary

- Date: 2026-08-21
- Note: libphoenix timerisset() stub implemented (found by new libc/time/timeval.c test); wctype/wide-char tests added; all pass on HW
...
| --- | --- | --- | --- |
| _build | main | dfae514 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | f7e979a (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
| phoenix-rtos-kernel | master | 8ae20864 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
| phoenix-rtos-tests | master | 7c284bc (clean) | https://github.com/phoenix-rtos/phoenix-rtos-tests.git |
...
_build	dfae51414243aa8185b4ac610a4eab9e382b19d5	main
libphoenix	f7e979a9dcce53f205ccbeb2cc512ba1634f9923	master
...
phoenix-rtos-kernel	8ae20864b010854c728ac6397e93c3388acafc31	master
...
phoenix-rtos-tests	7c284bc1973d5634659a946127184835389ae1ab	master
