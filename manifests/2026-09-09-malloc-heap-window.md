# Integration State: malloc-heap-window

## Summary

- Date: 2026-09-09
- Note: libphoenix 5ece71d: free() rejects a heap pointer outside the mmap'd-heap window, so a stray free is reported as such instead of a bogus double free; HW-verified no false positives (stdlib 92/0, test_malloc stress, unix-socket 27/0, desktop clean exit)
...
| --- | --- | --- | --- |
| _build | main | 239eedc67 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | 5ece71d (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
_build	239eedc67681aeb489dace5b431f3e5932e487b1	main
libphoenix	5ece71df35b3a82e33a2f35a47f877502f99a738	master
