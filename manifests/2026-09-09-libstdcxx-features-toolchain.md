# Integration State: libstdcxx-features-toolchain

## Summary

- Date: 2026-09-09
- Note: libstdc++ feature-macro fix promoted into .toolchain (gcc-16.2.0-12-libstdcxx-phoenix-features.patch); libphoenix clock_getres; --scope core rebuild 0 errors; netboot cycle reached psh with 0 faults
...
| --- | --- | --- | --- |
| _build | main | 4955f7e6d (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | 0604c8e (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
| phoenix-rtos-ports | master | c8a7076 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-ports.git |
...
_build	4955f7e6d2cfce22a4943918cb91dc6ea98c0181	main
libphoenix	0604c8e0735618c3d67e3e653e110d378b148a59	master
...
phoenix-rtos-ports	c8a7076b6d49454242440f18f5c09b908a81af39	master
