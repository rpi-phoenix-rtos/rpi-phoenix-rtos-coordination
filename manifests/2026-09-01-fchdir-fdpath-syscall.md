# Integration State: 2026-09-01-fchdir-fdpath-syscall

## Summary

- Date: 2026-09-01
- Note: Kernel sys_fdpath (fd->canonical-path) + libphoenix fchdir; fixes rm -r/fts. HW-verified: unistd_fsdir fchdir PASS, fsdiag2 rm -r rc=0, nl.sh flips to PASS.
...
| --- | --- | --- | --- |
| _build | main | 660a9af48 (dirty(9)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | 2e46a0a (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
| phoenix-rtos-ports | master | ea7fa4c (clean) | https://github.com/phoenix-rtos/phoenix-rtos-ports.git |
...
| phoenix-rtos-tests | master | e1fa434 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-tests.git |
...
_build	660a9af489b6cf5fa4716a5042ae273ffd0f1676	main
libphoenix	2e46a0a18e9890ae7da03c2fda59776343d4d346	master
...
phoenix-rtos-ports	ea7fa4c1b3a3dc0b6a7e32703698ea6fbd921255	master
...
phoenix-rtos-tests	e1fa434df4776da2ca89ccd6759eead12e8c2a9d	master
