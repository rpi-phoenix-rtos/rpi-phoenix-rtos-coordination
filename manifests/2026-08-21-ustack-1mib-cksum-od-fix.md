# Integration State: ustack-1mib-cksum-od-fix

## Summary

- Date: 2026-08-21
- Note: hal/aarch64 SIZE_USTACK 32KiB->1MiB: fixes coreutils cksum/od main-thread stack overflow Data Abort (HW-verified: Data Abort gone, correct CRC/hex)
...
| --- | --- | --- | --- |
| _build | main | de3e1ac (dirty(16)) | https://github.com/houp/phoenix-rpi.git |
...
_build	de3e1ac7d1715829ebd50d01906b8ae0b979cf29	main
