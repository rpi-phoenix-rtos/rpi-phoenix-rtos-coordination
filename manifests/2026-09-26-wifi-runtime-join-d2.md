# Integration State: wifi-runtime-join-d2

## Summary

- Date: 2026-09-26
- Note: Build 4: WiFi runtime join (connect/disconnect/status, netif supervisor) + D2 console fallbacks back to upstream. HW: wifirt1-d2 PASS (AP-side DISCOVER..ACK, DHCPRELEASE, second DISCOVER..ACK, ICMP 5/5 twice; /dev/console + /dev/tty0 present, psh interactive). Kernel working tree carries the uncommitted P2-E1 experiment at snapshot time; the recorded kernel SHA is the tested one.
...
| --- | --- | --- | --- |
| _build | main | 2c090c477 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-kernel | master | 1163cba1 (dirty(4)) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
_build	2c090c4775a1c84d3cd56ecdf9aaad09db54e867	main
...
phoenix-rtos-kernel	1163cba194ba70db04bc8fc3655d46cb0d801fb0	master
