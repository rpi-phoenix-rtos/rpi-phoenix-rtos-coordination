# Integration State: 2026-08-21-sysconf-nprocessors

## Summary

- Date: 2026-08-21
- Note: sysconf(_SC_NPROCESSORS_ONLN/CONF) implemented via new kernel pctl_cpucount platformctl; HW-verified ==4 on Pi4 (nproc/os.cpu_count now work)
...
| --- | --- | --- | --- |
| _build | main | 66492d8 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | 4fc67a9 (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
| phoenix-rtos-tests | master | f740c0c (clean) | https://github.com/phoenix-rtos/phoenix-rtos-tests.git |
...
_build	66492d8ae23a20c4c20613fd19b9100a1ece6e85	main
libphoenix	4fc67a92e20950bf5182dfec64d4a161629dcc8d	master
...
phoenix-rtos-tests	f740c0c6c42d36bca58cc91c531f5c63d65d4b0c	master
