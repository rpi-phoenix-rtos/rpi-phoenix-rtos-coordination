# Integration State: 2026-06-14-quake-textured-world-renders

## Summary

- Date: 2026-06-14
- Note: Quakespasm textured 3D world renders on V3D: root-caused gray-world to missing glFrontFace(GL_CW) (back-face cull). pl_phoenix_vid.c cull winding+GLWorld/GLAlias shaders, r_world.c element-VBO, mesa Export-failed suppression. E1M3 demo textured walls+lightmaps, demos cycle, 0 faults.
...
| --- | --- | --- | --- |
| _build | main | e3c43ca (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	e3c43ca516fdfb4f4480ec965364fe18dd07b26c	main
