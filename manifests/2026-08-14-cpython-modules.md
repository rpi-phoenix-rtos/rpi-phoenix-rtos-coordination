# Integration State: 2026-08-14-cpython-modules

## Summary

- Date: 2026-08-14
- Note: CPython static ext modules (socket/json/struct/math/...) HW-verified; libphoenix nextafter/nexttoward added
...
| --- | --- | --- | --- |
| _build | main | 2ae01d3 (dirty(24)) | https://github.com/houp/phoenix-rpi.git |
| libphoenix | master | c2900ab (clean) | https://github.com/phoenix-rtos/libphoenix.git |
...
_build	2ae01d35eb55d1af4d05f73eb9f799aedc04452f	main
libphoenix	c2900abfc9317308b4829d6854aed31b110f3dfe	master
