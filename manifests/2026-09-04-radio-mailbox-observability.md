# Integration State: 2026-09-04-radio-mailbox-observability

## Summary

- Date: 2026-09-04
- Note: rpi4-wifi/rpi4-hci: stage into the live fsid=0 export + report mailbox power-sequence failures (devices 843d193); HW-verified
...
| --- | --- | --- | --- |
| _build | main | 4bd75bfdf (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-ports | master | a85d217 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-ports.git |
...
_build	4bd75bfdfa11ee944906bef5edc8a00559f5fc1c	main
...
phoenix-rtos-ports	a85d217d9d1851c736eeb5115b9509960248882e	master
