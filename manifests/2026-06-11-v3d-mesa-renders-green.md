# Integration State: 2026-06-11-v3d-mesa-renders-green

## Summary

- Date: 2026-06-11
- Note: Ported Mesa v3d driver renders a green clear on the V3D from Phoenix (rpi4-v3d-mesa, boot-launched netboot): CL gen + winsys SUBMIT_CL + bin/render exec + readback 0xff00ff00. winsys self-powers V3D (v3d_phoenix_power.c); scout boot-launch disabled.
...
| --- | --- | --- | --- |
| _build | main | 8c16e1d (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | 330e97f (dirty(2)) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	8c16e1dad69146f8bf053f9fe0cad1af806b714a	main
...
phoenix-rtos-devices	330e97f7702e0451cc166a91d345213632f41a99	master
