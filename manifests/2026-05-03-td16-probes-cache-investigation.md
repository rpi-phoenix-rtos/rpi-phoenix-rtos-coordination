# Integration State: td16-probes-cache-investigation

## Summary

- Date: 2026-05-03
- Note: TD-16-1 probes landed (CNTFRQ+CNTPCT+arm_freq); TD-16 confirmed: caches off causes ~62x slowdown; cache enable attempts faulted on real Pi 4 in syspage_init
...
| phoenix-rtos-kernel | agent/rpi4-program-reloc | 843e6c61 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
phoenix-rtos-kernel	843e6c61973bf9f6798ac1784c14cb4a470d4d0f	agent/rpi4-program-reloc
