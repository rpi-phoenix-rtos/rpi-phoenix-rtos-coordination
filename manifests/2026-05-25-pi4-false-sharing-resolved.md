# Integration State: 2026-05-25-pi4-false-sharing-resolved

## Summary

- Date: 2026-05-25
- Note: TD-Pi4-FalseSharingPenalty resolved. Cache-line spread experiment proved false sharing on a 64-byte L1 line, not a kernel pmap bug. lwip ea936d3: per-slot _Alignas(64) padding restores plain volatile++ to ALU speed across 4 cores.
...
| --- | --- | --- | --- |
| _build | main | 778e6db (dirty(7)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | ea936d3 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	778e6db254f1b82f31fc4f6082bd4c6df859a1cd	main
...
phoenix-rtos-lwip	ea936d32f29ec9ed759fb1671e0cf2bdbccfbcf5	agent/rpi4-genet
