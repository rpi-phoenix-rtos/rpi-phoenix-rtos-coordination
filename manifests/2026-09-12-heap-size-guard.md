# Integration State: heap-size-guard

## Summary

- Date: 2026-09-12
- Note: libphoenix heap->size upper bound + wrap check; HW regression stdlib 93/0, misc 212/0, 0 faults, 0 guard fires
...
| --- | --- | --- | --- |
| _build | main | 9b4d4a77d (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-ports | master | 838b1f5 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-ports.git |
...
_build	9b4d4a77dd10c79d169ed639158b7a4bc9706bd8	main
...
phoenix-rtos-ports	838b1f5f6d1fecc1c7d17b33f03817ce8ad8e08a	master
