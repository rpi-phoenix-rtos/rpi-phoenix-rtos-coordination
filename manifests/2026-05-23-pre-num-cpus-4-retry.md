# Integration State: pre-num-cpus-4-retry
...
| --- | --- | --- | --- |
| _build | main | 00f3ef6 (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-kernel | agent/rpi4-program-reloc | d5fd747b (dirty(1)) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
_build	00f3ef6e7e59fef5d565b6cf0adaf3bf97cf7dcd	main
...
phoenix-rtos-kernel	d5fd747b01bf9c401d68b15f3d57a8617822eb8d	agent/rpi4-program-reloc
