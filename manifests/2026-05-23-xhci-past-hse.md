# Integration State: xhci-past-hse

## Summary

- Date: 2026-05-23
- Note: USB layer dissection cont'd. Post-mailbox BAR2 re-program fixed HSE on R/S=1. New failure: NOOP command completion timeout — controller doesn't emit event TRB in cmd ring response. xhci_init progress beyond runState into cmdNoopSelftest.
...
| --- | --- | --- | --- |
| _build | main | 1533677 (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | codex/upstream-sync-20260516 | fccc7ed (clean) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
_build	1533677b40322f49d31ae1b482ae4c5f146eacbf	main
...
phoenix-rtos-devices	fccc7ed90d90ad8e8740a6f83aa8bf32366369fc	codex/upstream-sync-20260516
