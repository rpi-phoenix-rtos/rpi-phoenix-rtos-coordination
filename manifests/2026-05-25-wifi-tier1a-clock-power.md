# Integration State: 2026-05-25-wifi-tier1a-clock-power

## Summary

- Date: 2026-05-25
- Note: WiFi Tier 1a probe: EMMC clock 250 MHz, EMMC2 100 MHz, SDCard power=0x1 at boot. Neither clock nor power is the gate. High-offset SDHCI register reads may still need investigation (could be script artifact).
...
| --- | --- | --- | --- |
| _build | main | 4b85938 (dirty(6)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | b658bc1 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	4b859385c95039d8eed0b0fcf13840bf5a8b7bd6	main
...
phoenix-rtos-lwip	b658bc1cb7ed70e0c0799d651a48db70c600a741	agent/rpi4-genet
