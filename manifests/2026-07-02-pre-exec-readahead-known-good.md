# Integration State: 2026-07-02-pre-exec-readahead-known-good

## Summary

- Date: 2026-07-02
- Note: Working full-system SD card (quake renders, X11 xeyes). Baseline before exec read-ahead VM change.
...
| --- | --- | --- | --- |
| _build | main | e812c00 (dirty(3)) | https://github.com/houp/phoenix-rpi.git |
