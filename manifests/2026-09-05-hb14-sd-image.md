# Integration State: hb14-sd-image

## Summary

- Date: 2026-09-05
- Note: SD image rpi4b-sd-2part-hb14-20260905.img (SHA256 45669a2d81...). Supersedes x11complete: adds harfbuzz 14.4.0 + the STK relink against it. Gates: 15/15 complete, image PASSES, 336 ELF / 0 stale, image-vs-export 336/336 byte-identical.
...
| --- | --- | --- | --- |
| _build | main | 42366b1b1 (dirty(2)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-ports | master | da41b10 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-ports.git |
...
_build	42366b1b11b1430fa984e7287cc0e07de3aefab9	main
...
phoenix-rtos-ports	da41b1000500f46f212caa5667a8db70eb95167b	master
