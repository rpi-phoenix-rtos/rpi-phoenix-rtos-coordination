# Integration State: 2026-05-25-wifi-tier1a-sdhci-accessible

## Summary

- Date: 2026-05-25
- Note: WiFi Tier 1a closed. SDHCI @ 0xfe300000 confirmed accessible from Phoenix userspace at boot — VERSION 0x99020000. v2 scout's earlier empty reply was a multi-mmap probe artifact. Tier 1 driver work unblocked.
...
| --- | --- | --- | --- |
| _build | main | f1586db (dirty(6)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | 812b0e9 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	f1586db073752c263c99d025316111ea92f5e434	main
...
phoenix-rtos-lwip	812b0e9d8441dc08b9070d78147a6f6f5ce978d1	agent/rpi4-genet
