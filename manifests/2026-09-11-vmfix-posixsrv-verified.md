# Integration State: vmfix-posixsrv-verified

## Summary

- Date: 2026-09-11
- Note: kernel 6cd3adec (vm/object premature-EOF retry) + posixsrv 211d49a upstream merge; boot-verified: banner+psh, test-libc-stdlib 93/0, test-libc-misc 212/0, 0 post-banner exceptions
...
| --- | --- | --- | --- |
| _build | main | 0d39e37e8 (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-tests | master | fc3dd0f (clean) | https://github.com/phoenix-rtos/phoenix-rtos-tests.git |
...
_build	0d39e37e8b072eef91ef908a90f16523ebbc9509	main
...
phoenix-rtos-tests	fc3dd0f87af450c738752aa2068f109020aa05b9	master
