# Integration State: 2026-08-22-clean-rebuild-pristine-rootfs

## Summary

- Date: 2026-08-22
- Note: Full clean rebuild (RESUME4 exit 0) + pristine NFS export. Fixed 3 latent xorg clean-build bugs (xorg_libs mirror-override f450916, xorg_apps libiconv dep db887a3, xorg_apps split-tree HTTPS fetch 6784881). Boot-verified: Quakespasm/GLQuake works; vkQuake hangs on persistent V3D binner wedge (mmu_ill, #51 open).
...
| --- | --- | --- | --- |
| _build | main | 25839f6 (dirty(4)) | https://github.com/houp/phoenix-rpi.git |
...
_build	25839f6efaffe5d20e03cd27ac2e99eeb135b52f	main
