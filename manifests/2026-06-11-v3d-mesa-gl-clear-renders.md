# Integration State: 2026-06-11-v3d-mesa-gl-clear-renders

## Summary

- Date: 2026-06-11
- Note: Mesa OpenGL frontend renders glClear(green) on the V3D end-to-end: st_create_context -> surfaceless make-current -> renderbuffer FBO -> glClear -> V3D -> glReadPixels readback=0xff00ff00. GL 2.1 / V3D 4.2.14.0. Boot-launched HW-validated (netboot). Also proved: 17MB binary execs from NFS rootfs (psh found it) but current single-threaded read-based loader too slow to page it in.
...
| --- | --- | --- | --- |
| _build | main | c812a7b (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | 8a89403 (dirty(2)) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
| phoenix-rtos-doc | master | 5083598 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-doc.git |
| phoenix-rtos-filesystems | master | 1628928 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-filesystems.git |
...
| phoenix-rtos-project | master | 77c9451 (dirty(1)) | https://github.com/phoenix-rtos/phoenix-rtos-project.git |
...
_build	c812a7bb0e54da4a7ec22accc84db1dd1a3e922c	main
...
phoenix-rtos-devices	8a89403ecdef42a4748b54bd4ef40d49b864cbb3	master
phoenix-rtos-doc	5083598b45ec21355a90467656c2c101ed217ea4	master
phoenix-rtos-filesystems	162892893211399d1ea85a17dd53c1b0d3316e6c	master
...
phoenix-rtos-project	77c9451932fd199ce77b5f7d854ab0fea68da134	master
