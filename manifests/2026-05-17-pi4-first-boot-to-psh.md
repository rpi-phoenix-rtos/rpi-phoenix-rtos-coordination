# Integration State: 2026-05-17-pi4-first-boot-to-psh

## Summary

- Date: 2026-05-17
- Note: First confirmed Pi 4 boot reaching psh shell. All sibling repos clean. Verified two-boot reproducibility. Armstub: 1319367 fix at CPUACTLR_EL1[46] + L2CTLR_EL1|=0x22 BCM2711 timing. Kernel: single-shot M|C|I + drop TD-04 NC + drop post-copy clean_inval. USB: pcie+xhci merged single-process. plo: M-only baseline (cache-on hangs on this silicon -- not retested post-armstub-fix).
...
| phoenix-rtos-kernel | agent/rpi4-program-reloc | 72242a05 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
| plo | codex/upstream-sync-20260516 | cf98b18 (clean) | https://github.com/phoenix-rtos/plo.git |
...
phoenix-rtos-kernel	72242a0562a88c0afbfd51e07627b08795c1ac0e	agent/rpi4-program-reloc
...
plo	cf98b18bbc04615f0c7bc83662ab30a65d1f97fd	codex/upstream-sync-20260516
```
