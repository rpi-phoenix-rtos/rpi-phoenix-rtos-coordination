# Integration State: demo-image-2940cc70

## Summary

- Date: 2026-09-11
- Note: Gated SD image 2940cc70: adds the STK graph-index guards missing from aa176f38 (ports patches 0014+0015, phoenix-rtos-ports 13d4a89) which take SuperTuxKart's crash from 1-in-3 to 0-in-12. Contents+FAT PASS, structural PASS, provenance read from the image's own ext2 root (ports 13d4a89), and the image's supertuxkart is sha256-identical to the binary built from all four guarded sources.
...
| --- | --- | --- | --- |
| _build | main | 0f2c9aa3c (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
_build	0f2c9aa3c79bf2332e0b7ae41b10c911c6784b72	main
