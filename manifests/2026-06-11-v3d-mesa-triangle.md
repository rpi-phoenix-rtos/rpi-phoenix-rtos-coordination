# Integration State: 2026-06-11-v3d-mesa-triangle

## Summary

- Date: 2026-06-11
- Note: Ported Mesa v3d driver renders a colored TRIANGLE on the V3D from Phoenix: util_make_* shaders compiled at draw via v3d_compile (NIR->QPU), geometry bin/render CLs, winsys SUBMIT_CL, V3D exec, readback center=0xff80403e (interpolated) corners=black. Full GPU-based-on-Mesa pipeline (geometry+runtime shaders) HW-verified.
...
| --- | --- | --- | --- |
| _build | main | efd7b2c (dirty(1)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-devices | master | a283ab5 (dirty(2)) | https://github.com/phoenix-rtos/phoenix-rtos-devices.git |
...
| phoenix-rtos-project | master | b8c5d1e (dirty(1)) | https://github.com/phoenix-rtos/phoenix-rtos-project.git |
...
_build	efd7b2c4c7bbc0d0e7fef1dacfc36b319533f401	main
...
phoenix-rtos-devices	a283ab5e0e862fd7720e062b8adeb53c88342d71	master
...
phoenix-rtos-project	b8c5d1e92637cad719c5c11b860b25ee4844755c	master
