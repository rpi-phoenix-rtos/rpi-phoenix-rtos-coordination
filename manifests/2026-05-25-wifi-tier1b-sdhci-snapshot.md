# Integration State: 2026-05-25-wifi-tier1b-sdhci-snapshot

## Summary

- Date: 2026-05-25
- Note: Full SDHCI 3.0 register snapshot at boot. Controller is firmware-initialized: clocks 250MHz, SD bus power 3.3V, interrupts pre-configured. CAPS=0 (Arasan vendor quirk). Tier 1 driver can skip controller setup and jump to bus-side bring-up (WL_REG_ON, GPFSEL3=ALT3, CMD5).
...
| --- | --- | --- | --- |
| _build | main | 3f059a5 (dirty(6)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | a66c25d (clean) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	3f059a5bccc8ba9f85c7c2f32bee6e7b6bbaf4c2	main
...
phoenix-rtos-lwip	a66c25d5ac4560da4a7246e770ebacb919294499	agent/rpi4-genet
