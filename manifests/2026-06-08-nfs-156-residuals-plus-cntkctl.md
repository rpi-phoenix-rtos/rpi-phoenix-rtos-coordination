# Integration State: nfs-156-residuals-plus-cntkctl

## Summary

- Date: 2026-06-08
- Note: #156 residuals: (e) takeover degrade-to-RAM-root, (c) errno de-mask + reframe, (f) lighttpd staged + CNTKCTL EL0-counter kernel fix (#157, A/B-proven); (g) MT designed-deferred. netboot+nfsroot validated, 0 faults.
...
| --- | --- | --- | --- |
| _build | main | 3f312da (dirty(3)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-kernel | master | 9d7f558b (clean) | https://github.com/phoenix-rtos/phoenix-rtos-kernel.git |
...
_build	3f312da698e1c11e1652bc2d62fdb873be48a5ce	main
...
phoenix-rtos-kernel	9d7f558ba86f000dc2e1bc06d7dbfa5f4a173972	master
