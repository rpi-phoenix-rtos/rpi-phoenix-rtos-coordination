# Integration State: 2026-05-25-eth-tier5b-mailbox-mac

## Summary

- Date: 2026-05-25
- Note: Eth Tier 5b — real MAC from VideoCore mailbox GET_BOARD_MAC. ARP shows dc:a6:32:3c:dd:f1 (real Pi OUI); PROMISC off; 5/5 pings RTT 0.66-1.42 ms. Resolves TD-Eth-MAC + TD-Eth-Promisc.
...
| --- | --- | --- | --- |
| _build | main | 0530816 (dirty(5)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | 79bd607 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	053081681d09005f6f6c6ebd8e92eaa3ba259fe6	main
...
phoenix-rtos-lwip	79bd6073207f84883c7815e61605b790fd1c45c3	agent/rpi4-genet
