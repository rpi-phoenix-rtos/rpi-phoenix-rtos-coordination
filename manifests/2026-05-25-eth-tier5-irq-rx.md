# Integration State: 2026-05-25-eth-tier5-irq-rx

## Summary

- Date: 2026-05-25
- Note: Eth Tier 5 — IRQ-driven RX + diagnostic cleanup. 5/5 host pings, RTT 0.612-1.173 ms (avg 0.916 ms) — ~8x faster than Tier 4. TX stays polled (single-slot, ~12us), link stays on 1Hz MDIO poll (PHY INT_B not routed).
...
| --- | --- | --- | --- |
| _build | main | 33414f9 (dirty(6)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | 789be33 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	33414f941d09ba9ea9471f4a8d7827b853a30cf0	main
...
phoenix-rtos-lwip	789be330c4fbd6158c5bca8f721db3f70e890149	agent/rpi4-genet
