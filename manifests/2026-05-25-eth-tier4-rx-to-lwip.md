# Integration State: 2026-05-25-eth-tier4-rx-to-lwip

## Summary

- Date: 2026-05-25
- Note: Eth Tier 4 partial — RX path now hands frames to lwIP via
  pbuf_alloc + pbuf_take + netif->input (tcpip_input). Tier 3
  diagnostic spam + smoke-test TX are gone. lwip starts cleanly, link
  comes up to 100Mbps full-duplex, no crash through end of capture.
  Network-level validation (responding to ARP, completing DHCP,
  replying to ICMP) needs either a static IP in the lwip cfg or
  interactive `ifconfig` from psh — not done in this snapshot.
...
| --- | --- | --- | --- |
| _build | main | d8109cd (dirty(6)) | https://github.com/houp/phoenix-rpi.git |
...
| phoenix-rtos-lwip | agent/rpi4-genet | a4a5b92 (clean) | https://github.com/phoenix-rtos/phoenix-rtos-lwip.git |
...
_build	d8109cd39d2bfba3bc725e4a66e222821a2f6cc2	main
...
phoenix-rtos-lwip	a4a5b92a2d2437e737e79f2c430bf852e7e9fef4	agent/rpi4-genet
