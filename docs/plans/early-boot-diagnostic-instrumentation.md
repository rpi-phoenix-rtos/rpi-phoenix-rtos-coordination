 ...
 * registers x21..x27. See docs/plans/early-boot-diagnostic-instrumentation.md.
 */
...
* `docs/TEMPORARY-FIXES-AND-FUTURE-CLEANUP.md` — TD-04, TD-15, TD-16
  reference labels used in source comments.
* `docs/research/boot-mmu-bringup-non-linux.md` — cross-OS convergent
