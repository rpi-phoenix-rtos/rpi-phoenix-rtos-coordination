...
- `docs/plans/cache-mmu-smp-impl.md` §2 Phase B (lines 77–122)
- `docs/research/boot-mmu-bringup-non-linux.md` §4 (lines 225–262)
- `docs/research/el2-to-el1-drop.md` §4 (lines 98–179)
...
1. **EL2→EL1 drop** in `_init.S` lines 188–246. Already landed.
   ...
   `docs/research/el2-to-el1-drop.md` §1.
...
(`docs/TEMPORARY-FIXES-AND-FUTURE-CLEANUP.md` lines 91–166) was
