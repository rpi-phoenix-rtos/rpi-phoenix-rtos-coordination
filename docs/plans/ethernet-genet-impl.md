...
Companion to the research briefs in `docs/research/ethernet-genet.md` and
`docs/research/ethernet-genet-non-linux.md`. This plan turns the surveyed
...
Reference: `docs/research/ethernet-genet-non-linux.md` Section 5
