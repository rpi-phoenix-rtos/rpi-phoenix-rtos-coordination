...
([usb-xhci-impl.md §6 Phase 3](usb-xhci-impl.md)) is wiring real HID
...
[scope §2.20 lines 504–523](../research/scope-pi4-uncovered.md)).
...
- **USB HID keystrokes end-to-end** ([usb-xhci-impl.md §6 Phase 3–4](usb-xhci-impl.md))
...
in [00-master-plan.md §4](00-master-plan.md). It is a pure
...
7. **HID layout assumption.** The xhci HID-to-ASCII map per
   [usb-xhci-impl.md §4 lines 151–155](usb-xhci-impl.md) is implied
