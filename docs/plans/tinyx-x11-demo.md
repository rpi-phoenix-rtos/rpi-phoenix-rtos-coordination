...
[`00-master-plan.md` M12](00-master-plan.md). It depends on essentially
...
[`usb-xhci-impl.md`](usb-xhci-impl.md). HID boot-mouse (subclass 0x01,
...
[`scope-pi4-uncovered.md` §2.1, §2.2](../research/scope-pi4-uncovered.md)).
...
|---|---|---|
| **Stage-1 caches (M2)** | [`cache-mmu-smp-impl.md`](cache-mmu-smp-impl.md) | Without caches, every X frame is rendered into uncached DRAM at fbcon speed (>10 min for 1080p in measured spike). Demo unwatchable. |
| **`/dev/fb0` (M8)** | [`gpu-vc6-impl.md`](gpu-vc6-impl.md) | Xfbdev's only display target. |
| **USB HID keyboard (M3)** | [`usb-xhci-impl.md`](usb-xhci-impl.md) | Phase 4 input. |
| **USB HID mouse (NEW, this plan §4.3)** | New | Phase 5 input. |
| **SDHCI + FAT/ext2 (M4)** | [`scope-pi4-uncovered.md` §2.1, §2.2](../research/scope-pi4-uncovered.md) | X assets (~10 MB) don't fit syspage. Phase 6/7 fully blocked without it. |
...
[`cache-mmu-smp-impl.md`](cache-mmu-smp-impl.md) (M2),
[`usb-xhci-impl.md`](usb-xhci-impl.md) (M3 + usbmouse reuse),
[`gpu-vc6-impl.md`](gpu-vc6-impl.md) (M8 `/dev/fb0`),
[`scope-pi4-uncovered.md`](../research/scope-pi4-uncovered.md) (§2.1
