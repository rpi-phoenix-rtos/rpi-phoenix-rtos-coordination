...
([`tinyx-x11-demo.md`](tinyx-x11-demo.md) §4.3, Phase 5). It commits no code; a
...
([`tinyx-x11-demo.md`](tinyx-x11-demo.md)) server and a future Quake-style game
...
- **Tier 3 (MUST) — Tiny-X consumes it.** Tiny-X's mouse backend reads
  ...
  [`tinyx-x11-demo.md`](tinyx-x11-demo.md) Phases 1-4 landing first).
...
DEV scan, [`docs/status.md`](../status.md) "Updated baseline"), so downstream
...
[`tinyx-x11-demo.md`](tinyx-x11-demo.md) §"Input — mouse" and §2) brings a PS/2
...
[`tinyx-x11-demo.md`](tinyx-x11-demo.md) §4.3 already specifies the mouse path:
...
2. **evdev `/dev/input/event1`** (Tier 4+/5, the path
   [`tinyx-x11-demo.md`](tinyx-x11-demo.md) §4.2 prefers for the keyboard) —
...
([`tinyx-x11-demo.md`](tinyx-x11-demo.md) §4.2 Design B) and is the right home
...
3. **BCM2711 PCIe bridge reliability.** The mouse inherits the host stack's
   ...
   across resets, [`docs/status.md`](../status.md) "USB status: statistical").
...
5. **Tiny-X (Tier 3 only).** Cursor demo depends on
   [`tinyx-x11-demo.md`](tinyx-x11-demo.md) Phases 1-4 (port skeleton, Xfbdev,
...
[`docs/status.md`](../status.md) once the host stack reaches enumeration and the
mouse becomes the active step in
[`tracking/current-step.md`](../../tracking/current-step.md). It is the concrete
realization of [`tinyx-x11-demo.md`](tinyx-x11-demo.md) §4.3 / Phase 5 and the
