...
[cache-mmu-smp-impl.md §1](../done/cache-mmu-smp-impl.md)). The kernel
...
([usb-xhci-impl.md §2](../done/usb-xhci-impl.md)). What works: serial console,
...
[`scope-pi4-uncovered.md` §4](scope-pi4-uncovered.md):
...
([cache-mmu-smp-impl.md §2](../done/cache-mmu-smp-impl.md));
USB host complete through HID keystrokes
([usb-xhci-impl.md §6](../done/usb-xhci-impl.md)); GENET Ethernet at lwIP
DHCP/ICMP/TCP tier
...
([scope-pi4-uncovered.md §5](scope-pi4-uncovered.md)).
...
≥ 3.5 GiB usable DRAM
([cache-mmu-smp-impl.md §6](../done/cache-mmu-smp-impl.md)).
...
1. **Stage-1 Phase A: I-cache enable.** Almost-zero risk, hours of
   work. Source: [cache-mmu-smp-impl.md §2 Phase A](../done/cache-mmu-smp-impl.md).
...
- **Plans:** [cache-mmu-smp-impl.md §1](../done/cache-mmu-smp-impl.md);
  [usb-xhci-impl.md §1](../done/usb-xhci-impl.md).
...
- **Plans:** [cache-mmu-smp-impl.md §2 all phases](../done/cache-mmu-smp-impl.md).
- **Prereqs:** M1.
...
- **Plans:** [usb-xhci-impl.md §6 Phases 1–5](../done/usb-xhci-impl.md).
...
- **Plans:** [ethernet-genet-impl.md §8 Phases 1–5](../done/ethernet-genet-impl.md).
...
- **Plans:** [cache-mmu-smp-impl.md §4](../done/cache-mmu-smp-impl.md).
...
- **Plans:** [cache-mmu-smp-impl.md §3](../done/cache-mmu-smp-impl.md).
- **Prereqs:** M2.
- **Duration:** 1–2 weeks.
...
- **Deliverable:** `rpi4-bcm2711-gpio` server Tiers 1–3; rtc-thermal
  Phases 1–4 complete.
- **Plans:** [gpio-pinctrl-impl.md §7](../done/gpio-pinctrl-impl.md);
  [rtc-thermal-power-impl.md §6](../done/rtc-thermal-power-impl.md).
...
1. **Mailbox driver: kernel-internal vs userspace server.**
   Recommendation in [rtc-thermal-power-impl.md §2, §10 Q1](../done/rtc-thermal-power-impl.md):
...
5. **DTB consumption depth.** Hardcode Pi-4-specific tables vs full
   ...
   [scope §2.14](scope-pi4-uncovered.md): hardcode for
...
6. **Public ABI shape for `/dev/fb0`, `/dev/gpiochip0`,
   ...
   - watchdog: skip Linux ioctls for now; zero-userspace driver
     covers operational need ([rtc §10 Q2](../done/rtc-thermal-power-impl.md)).

7. **Pi 4 SKU matrix for v1.0.** Pi 4B 4 GB only, or 1/2/4/8 GB,
   plus Pi 400 / CM4? Recommendation in
   [scope §2.15](scope-pi4-uncovered.md): 4 GB MUST,
...
Per [scope §2.26](scope-pi4-uncovered.md), Pi 5 moves all
...
3. **Forward-research agents** for scope-listed items not yet
   planned. Per [scope §6](scope-pi4-uncovered.md), spawn
