...
> raw logs (see `docs/done/2026-05-29-usb-reanalysis.md`) does **not**
...
- *`X` diag rig:* intermittent bridge-MMIO-dead (`pre USBSTS=0x00`/`0xdead`),
  ...
  rapid-cycle bridge-degradation window (`docs/inprogress/status.md:267-280`), which
...
`docs/done/2026-05-29-usb-reanalysis.md`. USB is therefore an **active
