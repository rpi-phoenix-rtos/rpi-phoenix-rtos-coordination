...
- Raspberry Pi 4 low-level survey:
  `docs/knowledge/raspberry-pi-4-low-level-reference-survey.md`
...
- the dedicated operator-facing first board-trial checklist is:
  `/Users/witoldbolt/phoenix-rpi/docs/knowledge/pi4-first-hardware-trial.md`
...
- that earlier bounded response was the post-stage-`4`
...
- the current bounded response is now one level narrower:
  - split the `mov xN, #0` block itself in two
  - the current image now distinguishes midpoint-of-clear from end-of-clear
