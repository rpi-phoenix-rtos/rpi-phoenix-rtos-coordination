...
- `docs/knowledge/git-repository-strategy.md`
- `docs/knowledge/host-macos-apple-silicon.md`
...
1. export the current full disk image:
   ...
   - focused trial checklist:
     [pi4-first-hardware-trial.md](/Users/witoldbolt/phoenix-rpi/docs/knowledge/pi4-first-hardware-trial.md)
