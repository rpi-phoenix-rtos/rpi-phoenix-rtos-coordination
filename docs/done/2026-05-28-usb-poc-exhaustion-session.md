...
Linux. Saved as `docs/knowledge/known-limits.md` with citations:
...
- `docs/knowledge/known-limits.md` (NEW) — Phoenix-internal-fix vs hardware-
  bounded distinction.
- `docs/inprogress/TEMPORARY-FIXES-AND-FUTURE-CLEANUP.md` tracking-checklist
