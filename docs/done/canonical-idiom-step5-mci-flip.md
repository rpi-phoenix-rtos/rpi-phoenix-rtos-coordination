...
runs (see `docs/knowledge/round3-cache-enable-synthesis.md` §5, lines
176–217). This document supersedes the earlier draft at
`docs/done/phase-b-detailed-diff.md` (lines 79–174); the round-3
...
The round-3 audit (`docs/knowledge/round3-phoenix-port-conventions-audit.md`
...
documented in `docs/done/phase-b-detailed-diff.md` §5 (lines 232–272)
