...
- **USB audio is out** until the USB host is unblocked. The xHCI bring-up is
  *statistically* failing today (cap-probe poisoning, PCIe-bridge degradation
  across resets — see [`docs/inprogress/status.md`](../inprogress/status.md) "USB status:
...
resets — [`docs/inprogress/status.md`](../inprogress/status.md), [`usb-xhci-impl.md`](../done/usb-xhci-impl.md)).
...
(see [`wifi-bcm43455-impl.md`](../inprogress/wifi-bcm43455-impl.md) §6 P0–P2 note).
...
4. GPIO function-select — the GPFSEL helpers already exist in diag-udp; a
   standalone GPIO/pinctrl driver ([`gpio-pinctrl-impl.md`](../done/gpio-pinctrl-impl.md))
...
from [`docs/inprogress/status.md`](../inprogress/status.md) when audio bring-up is scheduled.
