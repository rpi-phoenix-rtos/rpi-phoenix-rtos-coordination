...
[`docs/knowledge/round3-cache-enable-synthesis.md`](../knowledge/round3-cache-enable-synthesis.md)
§5.
...
+	 * alignment plan in docs/knowledge/round3-cache-enable-synthesis.md
...
`docs/knowledge/round3-phoenix-port-conventions-audit.md`).
...
Steps 1, 4, and 5
([`docs/knowledge/round3-cache-enable-synthesis.md:176-241`](../knowledge/round3-cache-enable-synthesis.md)).
