...
`docs/inprogress/status.md` (2026-05-28) entry and `docs/knowledge/known-limits.md`.
...
- This is the *only* signature that even looks silicon-shaped, and even
  ...
  - The project's own `docs/inprogress/status.md:267-280` documents **rapid-cycle
    ...
    regime.
  - `docs/inprogress/status.md:360-363` (CPU-side pmap bug) and memory
