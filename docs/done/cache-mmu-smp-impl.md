...
- `/Users/witoldbolt/phoenix-rpi/.claude/worktrees/dazzling-joliot-cd9889/docs/knowledge/el2-to-el1-drop.md`
- `/Users/witoldbolt/phoenix-rpi/.claude/worktrees/dazzling-joliot-cd9889/docs/knowledge/boot-mmu-bringup-non-linux.md`
...
(`docs/knowledge/boot-mmu-bringup-non-linux.md` §4) shows every
...
- **Secondary entry from armstub spin-table.** Armstub
  ...
  `docs/knowledge/el2-to-el1-drop.md` §6 "Secondary cores". No armstub
  change needed.
