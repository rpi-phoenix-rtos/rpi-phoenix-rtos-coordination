...
| QuakeSpasm (GLQuake) | ✅ HW-validated | textured GLQuake ~40fps@1080p, demos + SP map, 0 faults; multiplayer not a tested/supported path (`project_quakespasm_port`) |
