 ...
 **NEXT:** execute G3.3 (self-flash SD-boot verify: psh + ext2 root + a game + bash -i, 0 faults) → G5 (manifest + tag known-good/gcc16-release-2026-08-25 across the 4 pushed repos + coord + org README flip + publish the image artifact with its sha256). Both Monitors fired the success + ended.
