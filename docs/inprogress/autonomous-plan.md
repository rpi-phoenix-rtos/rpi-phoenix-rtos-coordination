 ...
 **NEXT:** Issue 2 (vkQuake torches — likely the #51 V3D binner wedge, deep/HW-marginal) + Issue 3 (X11 GL Y-offset — present-origin, same family as glamor PHX_READBACK_FLIP_Y). Also fixed quake2-launcher video args (c411b87) + nfs-fs readdir ./.. (ee32037) earlier this session. Other GL games (quake2/quake3) inherit the libv3d fix but need relink+restage to pick it up.
