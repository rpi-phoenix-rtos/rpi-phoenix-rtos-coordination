 ...
 **NEXT:** (polish) stage /usr/share/WindowMaker images to -gcc16 for wmaker backgrounds/logos; Quake2 mip-vs-lightmap discriminator (owner-runnable gl_texturemode); g34 release boot-verify.
