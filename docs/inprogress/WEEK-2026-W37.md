...
from the input verification above — same build), SuperTuxKart **2/2**, Quake III running.
Remaining: STK T3, Q3, QuakeSpasm, Q2, vkQuake. The current shipping image predates the xHCI
