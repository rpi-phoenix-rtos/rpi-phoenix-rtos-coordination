...
⏭ Cheapest decisive test: dump the **whole page** at a fault, not just registers — other-object
bytes ⇒ page-content bug; stale-but-plausible STK bytes ⇒ a reuse/lifetime bug.
