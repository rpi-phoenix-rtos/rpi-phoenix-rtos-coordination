...
- **Not yet done: re-bench desktop / QuakeSpasm / Q2 / vkQuake on this exact image.** Until
  that runs, this is "gate passed on the parent build, one component re-verified" — not a
  fresh 5/5. Next heartbeats.
