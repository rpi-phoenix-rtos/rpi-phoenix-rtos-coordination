...
**Re-gate on the guard-page build:** desktop ✅ **3/3**, Quake III ✅ **3/3**,
QuakeSpasm ✅ **3/3**, Quake II ✅ **3/3**, vkQuake **2/2 so far** — all 0 faults, 14 clean boots.
Remaining: vkQuake T3, then STK's 3 trials as the 6th component. Only after that does a new
image get cut — the shipping deliverable stays the earlier gated image (5/5, 15 boots,
0 faults) until then.
