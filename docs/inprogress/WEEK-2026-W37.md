...
crashes".
ⓘ `0x80000001` is **not** one of our constants; little-endian it means a pointer-looking low word
followed by `0x80000001`, i.e. a pointer whose **high 32 bits were overwritten** (or a 32-bit-stored
pointer read as 64 — a recurring class here). **No Pi time spent.**
