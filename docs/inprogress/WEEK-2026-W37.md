...
- **2026-09-12 sweep.** Siblings: **kernel 5 behind, project 1, tests 2** — unchanged in character
  from yesterday, see below; nothing merged. Game forks: **quake3e / quakespasm / yquake2 all 0
  behind**; **vkquake 40 behind, staying behind by your rule** (same ray-tracing / SSAO / MoltenVK
  set, a re-port not a merge). All four generated port patches **OK, no drift**.
