...
worked. Something since then broke it. Two tracks: get STK demo-usable now via the flag
(benching next), and separately bisect what regressed the advanced pipeline.
