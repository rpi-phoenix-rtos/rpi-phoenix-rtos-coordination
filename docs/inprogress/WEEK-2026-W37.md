...
⏳ **Six-app showcase gate running now** on the clean build. A refreshed demo image is the intended
next step — the delivered `2940cc70` predates this fix — but nothing is cut until the gate passes.
