...
⏳ **Committed but NOT built/tested** — the Pi is mid-bench and rebuilding would swap the binary under
a running trial. Next heartbeat: build 0017, verify by content, re-run the STK bench.
