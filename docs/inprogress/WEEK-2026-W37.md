...
## 4e. wmaker-exit EL0 fault: NOT retested — three invalid attempts, recorded as such
...
**Plan:** give `pl_phoenix_xlaunch` a `--quit-after <secs>` option. It is our own launcher, used
