...
**Re-gate on the guard-page build, in progress:** desktop **2/2** so far (0 faults, glamor,
5 clients each). Remaining: desktop T3, Q3, QuakeSpasm, Q2, vkQuake, and STK as the 6th.
Only after that does a new image get cut — the shipping deliverable stays the earlier gated
image (5/5, 15 boots, 0 faults) until then.
