...
0 faults, desktop upright, GoL xterm clean, all six clients render. **The games are untouched** —
the flag defaults to 1 and only the X shim clears it, so no game was relinked or re-tested.
