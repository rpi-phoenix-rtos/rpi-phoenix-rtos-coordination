...
QuakeSpasm **2/2 so far** — all 0 faults. Remaining: QuakeSpasm T3, Q2, vkQuake, and STK as the
6th component. Only after that does a new image get cut — the shipping deliverable stays the
earlier gated image (5/5, 15 boots, 0 faults) until then.
