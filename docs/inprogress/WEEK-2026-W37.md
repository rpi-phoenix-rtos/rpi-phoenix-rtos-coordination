...
not a Pi failure. **Determinism is the next question** (1/3 = flakiness, 3/3 = regression to
bisect), but it ranks BELOW re-gating the five components that the SD image actually ships.
