...
(see `docs/rpi4-os-development-guide.md` §"PCIe + USB"). The stated
...
`docs/rpi4-os-development-guide.md` §"Worked example: the USB
...
- **H2 confirmed** (throttle bit 0/16 correlates with mode B):
  ...
  `docs/TEMPORARY-FIXES-AND-FUTURE-CLEANUP.md`. Swap PSU and re-test.
...
- `docs/rpi4-os-development-guide.md` §"PCIe + USB" — narrative.
- `docs/TEMPORARY-FIXES-AND-FUTURE-CLEANUP.md` `TD-Pi4-FalseSharingPenalty`.
