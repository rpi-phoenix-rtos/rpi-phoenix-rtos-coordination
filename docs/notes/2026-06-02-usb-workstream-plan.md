...
or kill the network (`docs/notes/2026-06-01-usb-rearchitecture-plan.md`, "STEP 3
...
**RESOLVED 2026-06-02 (A/B test, `docs/notes/2026-06-02-p1-ab-verdict.md`):** the
...
- The 2026-06-02 10-boot study reports **USB enum 3/10 → 10/10 "clean"**
  (`docs/notes/2026-06-02-p1p2p3-postfix-10boot.md:73-77`), explicitly claiming
...
The FIX-* items are **not** in `docs/TEMPORARY-FIXES-AND-FUTURE-CLEANUP.md`
...
`docs/gpu-quake-bringup-plan.md` exists for that workstream. So D is **not**
...
- **FIX-* items are not in `TEMPORARY-FIXES-AND-FUTURE-CLEANUP.md`** (only TD-NN
  ...
  a dedicated `docs/usb-fix-ledger.md`; today it is scattered across notes +
