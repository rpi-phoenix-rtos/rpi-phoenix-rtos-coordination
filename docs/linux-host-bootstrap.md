...
Read [`docs/build-cache-and-cold-boot-races.md`](build-cache-and-cold-boot-races.md)
and [`docs/console-architecture-and-fbcon.md`](console-architecture-and-fbcon.md)
...
- **USB keyboard interactive verification** (Task #3 in the session task
  ...
  reach psh. Runbook at [`docs/interactive-verification-runbook.md`](interactive-verification-runbook.md).
