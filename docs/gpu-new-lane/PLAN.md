...
| E3 / E6 | Does the pinned firmware honour `SET_PLANE` + raise SMI vblank IRQs? Which physical range can it scan? | [E3-firmware-planes-vblank.md](E3-firmware-planes-vblank.md) | ✅ **Stage A viable**: vblank IRQ 60.01 Hz; planes on HDMI; 60 vsynced flips/s 0 missed; 12 443 flips/s unsynced (SET_PLANE p50 78 µs); scans low and >1 GiB memory; 256 MiB contiguous OK |
