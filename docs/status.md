...
1. Add reusable AArch64 architectural timer sysreg helpers.
2. Reassess the next smallest runtime follow-up after that helper step, likely the first generic ARM timer backend step.
