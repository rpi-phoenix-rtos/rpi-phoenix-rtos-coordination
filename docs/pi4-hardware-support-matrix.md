...
`docs/research/scope-pi4-uncovered.md`; for live progress see `docs/status.md`.
...
| HDMI framebuffer **device** `/dev/fb0` | 🔬 groundwork | userspace FB mmap rw proven on HW (diag-udp `V`) | 2 attended decisions: display ownership + no-fbdev ABI (`docs/notes/2026-06-05-fb0-attended-decisions.md`) |
...
| Audio (PWM / I²S / HDMI) | ⬜ not started | plan `docs/plans/pi4-audio-impl.md` | validation needs speaker/scope (⏸) |
