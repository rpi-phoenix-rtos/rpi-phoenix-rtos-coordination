...
|---|---|---|
| This coordination repo's original code (build/lab scripts, port tooling, docs) | `scripts/`, `tools/` (our `*.sh`/`*.py`/`build.project`-style glue), `docs/`, `manifests/` | **BSD 3-Clause** ([LICENSE](LICENSE)) |
